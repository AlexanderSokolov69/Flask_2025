...
from PyQt6.QtWidgets import QApplication, QLabel, QLineEdit, QMainWindow, QPushButton, QCheckBox
    ...
    def refresh_map(self):
        ...
        if geo_locate(self.g_search.text(), inform_map=True) != (-1, -1):
            self.inform_map.setText(
                f'{geo_locate(self.g_search.text(), inform_map=True, index_map=self.g_index.isChecked())}')
